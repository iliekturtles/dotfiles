...
{{#if dotter.packages.nvidia}}AddPackage lib32-nvidia-utils # nvidia-dkms # NVIDIA drivers - module sources{{/if}}
...
{{#if dotter.packages.rust}}AddPackage cargo-watch # Utility for Cargo to compile projects when sources change{{/if}}
