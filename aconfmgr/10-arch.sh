...
{{#if dotter.packages.games}}{{#if games.gcompris}}AddPackage gcompris-qt # Educational software suite comprising of numerous activities for children aged 2 to 10{{/if}}{{/if}}
...
{{#if dotter.packages.linux}}{{#if dotter.packages.amdgpu}}CopyFile /etc/mkinitcpio.conf.d/amdgpu.conf{{/if}}{{/if}}
